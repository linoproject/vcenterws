...
app.post(properties.api + '/changePassword', function(req, res) {
    ...
    db_vcenterws_db.User.findOne({ username: req.user.username, password: req.body.passwordOld }).exec(function(err, user) {
...
var getUser = function(username, password, callback) {
    ...
    db_vcenterws_db.User.findOne({ username: username, password: password }).lean().exec(function(err, user) {
        if (user)
            user.password = undefined;
        callback(user);
    });
...
var createUser = function() {
    ...
    db_vcenterws_db = require('../db/vcenterws_db_schema.js');
